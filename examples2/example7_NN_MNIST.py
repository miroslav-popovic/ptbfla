...
def define_neurons(X, Y):
    ...
    hidden_layer_neurons = 128 # hidden layer of size 10
...
def data_split(data, num_clients):

    # This function devides data into train data and test data, and then splits train data into num_clients partitions
...
def seq_horizontal_federated(num_clients):
    ...
    X_train_list, Y_train_list, X_test, Y_test = data_split(data, num_clients)
...
def main():
    ...
    X_train_list, Y_train_list, X_test, Y_test = data_split(data, noNodes-1)
