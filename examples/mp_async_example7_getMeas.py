...
async def main_1(no_nodes, node_id):
    ...
    obs = await ptb.getMeas(peer_ids, odata)  # simulate measurements
...
async def start_main():
    ...
    """
    call as launch example7_getMeas.py no_nodes id your_IP_address
    ex.:
        launch example7_getMeas.py 11 id your_IP_address
        launch example7_getMeas.py 20 id your_IP_address
        launch example7_getMeas.py 170 id your_IP_address
    """
    ...
    await main_3(
        node_id
    )  # every satelite talks to everyone except itself, broadcast like


WAIT_TIME = 5  # This value controls how long the wait between the examples is
